...
class ChatGPT3TelegramBot:
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text("/reset - Оновлює бесіду\n"
                                        "/hello - Hello! This is ChatGPT_Bot!\n"
                                        "/help - Меню помічника\n\n",
    ...
    async def hello(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        """
        await update.message.reply_text("Hello! This is ChatGPT_Bot! Ask me a question ;)")
    ...
    def run(self):
        ...
        application.add_handler(CommandHandler('hello', self.hello))
